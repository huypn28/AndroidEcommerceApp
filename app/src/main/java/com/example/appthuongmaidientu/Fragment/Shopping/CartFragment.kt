...
import com.example.appthuongmaidientu.Adapter.CartProductAdapter
...
import com.example.appthuongmaidientu.databinding.FragmentCartBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.productsPrice.collectLatest { price->
                price?.let {
                    totalPrice=it
                    binding.tvTotalPrice.text="${String.format("%.0f", price)} VNĐ"
                }
            }
        }
