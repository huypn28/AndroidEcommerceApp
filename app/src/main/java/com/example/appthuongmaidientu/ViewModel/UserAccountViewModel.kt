...
import com.example.appthuongmaidientu.AppThuongMaiDienTu
...
import com.example.appthuongmaidientu.Util.validateEmail
        ...
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(
                    getApplication<AppThuongMaiDienTu>().contentResolver,
                    imageUri
                )
